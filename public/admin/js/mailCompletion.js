...
function hcMailCompletion(mailId){
	...
	this.hcShowMailList = function(){
		...
		if($('#hcShowMailList').size() < 1){
			...
			'#hcShowMailList{width:'+hcShowMailListWidth+'px; position:absolute; z-index:8; left:50px; top:0px;padding:8px '+this.padding+'px; border:'+this.borderWidth+'px '+this.borderType+' '+this.borderColor+'; overflow:hidden; background:'+this.bgColor+';}'+
